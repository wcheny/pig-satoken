package com.wangchenyang.auth.support.core;
 ...
 * @date 2022-06-04
 */
public class YifanDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public YifanDaoAuthenticationProvider() {
