 ...
 */
@Slf4j
public class YifanSentinelInvocationHandler implements InvocationHandler {
	...
	YifanSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			YifanSentinelInvocationHandler other = (YifanSentinelInvocationHandler) obj;
