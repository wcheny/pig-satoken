package com.wangchenyang.common.mybatis.utils;
...
public class EncryptDecrypt {
	...
	private static  final AES aes = new AES("CBC", "PKCS7Padding", "zIMThzhHWaS3OS2x".getBytes(), "FkVhNodJIP3FN1OX".getBytes());
	/**
	 * 加密
	 *
