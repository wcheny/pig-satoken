...
package com.wangchenyang.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public YifanUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof YifanUser) {
			return (YifanUser) principal;
		}
		return null;
	}
